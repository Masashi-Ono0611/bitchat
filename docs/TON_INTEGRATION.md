...
> Status: MVP Implementation in progress (`ton-mvp` branch)
> Branch: `ton` — TON integration base; `main` tracks upstream bitchat
> Reference: [meshpay-ton TypeScript spec](https://github.com/Masashi-Ono0611/meshpay-ton) (archived — bitchat is the primary workspace)
